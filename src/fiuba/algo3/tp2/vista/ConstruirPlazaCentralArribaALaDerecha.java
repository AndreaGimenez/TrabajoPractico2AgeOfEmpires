...
public class ConstruirPlazaCentralArribaALaDerecha implements AccionPosicionarEdificio {

    private PosicionarEdificio posicionador;
    private String identificador;

    public ConstruirPlazaCentralArribaALaDerecha(Aldeano aldeano) {
    ...
    public void realizarConstruccion() {
        try {
            this.posicionador.posicionarArribaPorLaDerecha(EdificioConstants.TipoEdificio.PLAZA_CENTRAL);
