...
public class ConstruirPlazaCentralAristaSuperiorIzquierda implements AccionPosicionarEdificio {

    private PosicionarEdificio posicionador;
    private String identificador;

    public ConstruirPlazaCentralAristaSuperiorIzquierda(Aldeano aldeano) {
        this.posicionador = new PosicionarEdificio(aldeano);
        this.identificador = "Construir en arista superior izquierda";
    }

    @Override
    public void realizarConstruccion() {
        try {
            this.posicionador.posicionarEnAristaSuperiorIzquierda(EdificioConstants.TipoEdificio.PLAZA_CENTRAL);
