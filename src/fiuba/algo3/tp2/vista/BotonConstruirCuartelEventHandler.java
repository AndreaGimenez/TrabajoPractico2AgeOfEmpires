...
public class BotonConstruirCuartelEventHandler implements EventHandler<ActionEvent> {
    ...
    public BotonConstruirCuartelEventHandler(Button accionConstruir, PosicionarEdificio posicionarEdificio) {
    ...
    public void handle(ActionEvent event) {
        ...
        try {
            posicionador.posicionarArribaPorLaDerecha(new Cuartel());
