...
public class ConstruirCuartelAristaInferiorIzquierda implements AccionPosicionarEdificio {

	private PosicionarEdificio posicionador;
	    private String identificador;
	    
	    public ConstruirCuartelAristaInferiorIzquierda(Aldeano aldeano) {

	        this.posicionador = new PosicionarEdificio(aldeano);
	        this.identificador = "Construir en la esquina inferior izquierda";
	    }
		...
		public void realizarConstruccion() {
			...
			try {
	            this.posicionador.posicionarEnAristaInferiorIzquierda(EdificioConstants.TipoEdificio.CUARTEL);
